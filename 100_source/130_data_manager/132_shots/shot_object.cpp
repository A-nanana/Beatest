...
<<<<<<< HEAD
	...
	//ÉJÉEÉìÉgÇ™êÿÇÍÇƒÇ¢ÇÈÇ©
	if (inner_count_ < 0.0f) {
=======
	// ‰∫àÂëä‰∏≠„ÅØÂ∏∏„Å´ÁÑ°Âà§ÂÆö
	if (pre_count_ > 0.0f) {
		hit_use_ = false;
	}
	else {
		// „É¨„Éº„Ç∂„ÉºÊú¨‰Ωì„Ç´„Ç¶„É≥„Éà
		inner_count_ -= delta_time;
		hit_use_ = true;
	}
	//?J?E???g?????????
...
<<<<<<< HEAD
		...
		//ÉJÉEÉìÉgÇ™êÿÇÍÇÈÇ‹Ç≈ÇÕó\çêê¸ÇÃÇ›èoÇ∑
		if (!hit_use_) {
...
=======
		...
		// ‰∫àÂëäÁ∑ö„Ç´„Ç¶„É≥„Éà„Å´Âêà„Çè„Åõ„Å¶Ë°®Á§∫„ÇíÂàá„ÇäÊõø„Åà„Çã
		if (pre_count_ > 0.0f) {
