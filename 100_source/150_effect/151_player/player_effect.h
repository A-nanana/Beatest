...
// @memo   
//------------------------------
class HitDotEffect :public AlphaNode {
...
public:
	//  コンストラクタ
	HitDotEffect(int loop_max, int time_per_loop, Vector2D vector_point, Vector2D size, int red, int green, int blue, int type);
	HitDotEffect(int loop_max, int time_per_loop, Vector2D vector_point, Vector2D size, int color_code, int type);
